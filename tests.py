...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        self.assertNotIn(b"Games", result.data)
...
class PartyTestsDatabaseNoRSVP(unittest.TestCase):
...
class PartyTestsDatabaseYesRSVP(unittest.TestCase):
    """Flask tests that use the database."""
    ...
    def test_games(self):
        ...
        self.assertIn(b"Foriegn Arrow", result.data)
